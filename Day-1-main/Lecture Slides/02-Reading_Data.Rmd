...
hiphop <- read.csv("/Users/kbodwin/Dropbox/Data/hiphop.csv")
...
Highly formatted files like in Microsoft Word are often passed along in RTF.  This contains "hidden" characters that throw off the data read.

--

*Solution:*  Save it as a `.txt`

--

**Incomplete Lines:**

If some of the columns are missing, and they are not labelled properly, the file will read wrong.

--

*Solution:* Pay attention to warnings and to variable types.  Spot check.
...
1. Look for common errors in the data format/read.

2. Understand what information is recorded in the dataset.

3. Get a general sense of the values of each variable.
