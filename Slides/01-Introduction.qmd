...
Alternatively, create a [Posit Cloud Account](posit.cloud).
...
On Posit Cloud, choose *New Project > GitHub Repository* and enter `https://github.com/Docere-Data-Science/Intro-to-Tidyverse`

. . .

Then, open the file in the `Activities` folder named `01-Setup.qmd`.